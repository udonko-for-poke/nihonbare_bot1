...
def get_pokedata(urlName):
    ...
    get = int(re.sub(r'[^0-9].*', '', status_[i+1].get_text().replace(u'\xa0', '')))
...
#    return
    ...
    pokeid = 0
    poke_content = sqlite3.connect(os.path.dirname(__file__)+'/sqldata/pokemon2.sqlite3')
    poke_c = poke_content.cursor()
...
#    print(get_pokedata2('https://yakkun.com/swsh/zukan/n96'))
    make_poke2move()
#    main()
#    result1 = get_pokedata('https://yakkun.com/swsh/zukan/n681b')
#    print(result1)
